...
parser.add_argument("--skip-torch-cuda-test", action='store_true', default=True, help="launch.py argument: do not check if CUDA is able to work properly")
parser.add_argument("--no-half", action='store_true', default=True, help="do not switch the model to 16-bit floats")
parser.add_argument("--use-cpu", nargs='+', default=[], type=str.lower, help="use CPU as torch device for specified modules")
